...
export DICOM_INTEROP_ORTHANC_CALLING_AE="${DICOM_INTEROP_ORTHANC_CALLING_AE:-MTKSMOKE}"
...
export DICOM_INTEROP_DCM4CHEE_CALLING_AE="${DICOM_INTEROP_DCM4CHEE_CALLING_AE:-MTKSMOKE}"
